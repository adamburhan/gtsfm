...
If the genuinely near-edge subset (<~1 drift-sigma) behaves differently from the pooled set,
the pooled metric was diluted by keypoints that were never realistically ambiguous.
